DROP DATABASE IF EXISTS db_historial_clinico;
    CREATE DATABASE db_historial_clinico CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci;
    USE db_historial_clinico;
