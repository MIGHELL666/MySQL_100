DROP DATABASE IF EXISTS db_laboratorio_resultados;
    CREATE DATABASE db_laboratorio_resultados CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci;
    USE db_laboratorio_resultados;
