DROP DATABASE IF EXISTS db_gimnasio_entrenamientos;
    CREATE DATABASE db_gimnasio_entrenamientos CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci;
    USE db_gimnasio_entrenamientos;
