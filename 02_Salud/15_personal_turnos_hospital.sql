DROP DATABASE IF EXISTS db_personal_turnos_hospital;
    CREATE DATABASE db_personal_turnos_hospital CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci;
    USE db_personal_turnos_hospital;
