DROP DATABASE IF EXISTS db_registro_vacunacion;
    CREATE DATABASE db_registro_vacunacion CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci;
    USE db_registro_vacunacion;
