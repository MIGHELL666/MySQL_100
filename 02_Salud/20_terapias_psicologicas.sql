DROP DATABASE IF EXISTS db_terapias_psicologicas;
    CREATE DATABASE db_terapias_psicologicas CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci;
    USE db_terapias_psicologicas;
