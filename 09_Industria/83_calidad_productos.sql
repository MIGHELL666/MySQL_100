DROP DATABASE IF EXISTS db_calidad_productos;
    CREATE DATABASE db_calidad_productos CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci;
    USE db_calidad_productos;
