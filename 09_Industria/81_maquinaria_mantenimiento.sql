DROP DATABASE IF EXISTS db_maquinaria_mantenimiento;
    CREATE DATABASE db_maquinaria_mantenimiento CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci;
    USE db_maquinaria_mantenimiento;
