DROP DATABASE IF EXISTS db_envios_logistica;
    CREATE DATABASE db_envios_logistica CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci;
    USE db_envios_logistica;
