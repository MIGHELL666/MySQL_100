DROP DATABASE IF EXISTS db_pedidos_mayoristas;
    CREATE DATABASE db_pedidos_mayoristas CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci;
    USE db_pedidos_mayoristas;
