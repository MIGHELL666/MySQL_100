DROP DATABASE IF EXISTS db_proveedores_internacionales;
    CREATE DATABASE db_proveedores_internacionales CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci;
    USE db_proveedores_internacionales;
