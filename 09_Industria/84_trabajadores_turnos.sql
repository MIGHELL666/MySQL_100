DROP DATABASE IF EXISTS db_trabajadores_turnos;
    CREATE DATABASE db_trabajadores_turnos CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci;
    USE db_trabajadores_turnos;
