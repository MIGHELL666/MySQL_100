DROP DATABASE IF EXISTS db_inventario_materias_primas;
    CREATE DATABASE db_inventario_materias_primas CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci;
    USE db_inventario_materias_primas;
