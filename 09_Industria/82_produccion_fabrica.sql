DROP DATABASE IF EXISTS db_produccion_fabrica;
    CREATE DATABASE db_produccion_fabrica CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci;
    USE db_produccion_fabrica;
