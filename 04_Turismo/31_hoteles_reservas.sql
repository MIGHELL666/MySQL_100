DROP DATABASE IF EXISTS db_hoteles_reservas;
    CREATE DATABASE db_hoteles_reservas CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci;
    USE db_hoteles_reservas;
