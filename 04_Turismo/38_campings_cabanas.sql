DROP DATABASE IF EXISTS db_campings_cabanas;
    CREATE DATABASE db_campings_cabanas CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci;
    USE db_campings_cabanas;
