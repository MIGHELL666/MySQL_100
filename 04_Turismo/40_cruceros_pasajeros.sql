DROP DATABASE IF EXISTS db_cruceros_pasajeros;
    CREATE DATABASE db_cruceros_pasajeros CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci;
    USE db_cruceros_pasajeros;
