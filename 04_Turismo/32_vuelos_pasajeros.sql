DROP DATABASE IF EXISTS db_vuelos_pasajeros;
    CREATE DATABASE db_vuelos_pasajeros CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci;
    USE db_vuelos_pasajeros;
