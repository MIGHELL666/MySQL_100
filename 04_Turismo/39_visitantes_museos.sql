DROP DATABASE IF EXISTS db_visitantes_museos;
    CREATE DATABASE db_visitantes_museos CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci;
    USE db_visitantes_museos;
