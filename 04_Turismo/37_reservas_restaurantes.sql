DROP DATABASE IF EXISTS db_reservas_restaurantes;
    CREATE DATABASE db_reservas_restaurantes CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci;
    USE db_reservas_restaurantes;
