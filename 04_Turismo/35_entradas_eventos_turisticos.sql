DROP DATABASE IF EXISTS db_entradas_eventos_turisticos;
    CREATE DATABASE db_entradas_eventos_turisticos CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci;
    USE db_entradas_eventos_turisticos;
