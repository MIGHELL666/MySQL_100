DROP DATABASE IF EXISTS db_influencers_colaboraciones;
    CREATE DATABASE db_influencers_colaboraciones CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci;
    USE db_influencers_colaboraciones;
