DROP DATABASE IF EXISTS db_campanas_publicitarias;
    CREATE DATABASE db_campanas_publicitarias CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci;
    USE db_campanas_publicitarias;
