DROP DATABASE IF EXISTS db_resenas_valoraciones;
    CREATE DATABASE db_resenas_valoraciones CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci;
    USE db_resenas_valoraciones;
