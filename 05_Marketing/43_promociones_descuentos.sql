DROP DATABASE IF EXISTS db_promociones_descuentos;
    CREATE DATABASE db_promociones_descuentos CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci;
    USE db_promociones_descuentos;
