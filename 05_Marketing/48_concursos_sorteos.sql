DROP DATABASE IF EXISTS db_concursos_sorteos;
    CREATE DATABASE db_concursos_sorteos CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci;
    USE db_concursos_sorteos;
