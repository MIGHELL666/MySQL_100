DROP DATABASE IF EXISTS db_encuestas_satisfaccion;
    CREATE DATABASE db_encuestas_satisfaccion CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci;
    USE db_encuestas_satisfaccion;
