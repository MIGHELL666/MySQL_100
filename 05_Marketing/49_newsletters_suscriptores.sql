DROP DATABASE IF EXISTS db_newsletters_suscriptores;
    CREATE DATABASE db_newsletters_suscriptores CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci;
    USE db_newsletters_suscriptores;
