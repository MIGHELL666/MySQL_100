DROP DATABASE IF EXISTS db_clientes_potenciales;
    CREATE DATABASE db_clientes_potenciales CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci;
    USE db_clientes_potenciales;
