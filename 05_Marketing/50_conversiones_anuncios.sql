DROP DATABASE IF EXISTS db_conversiones_anuncios;
    CREATE DATABASE db_conversiones_anuncios CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci;
    USE db_conversiones_anuncios;
