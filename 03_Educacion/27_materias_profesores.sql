DROP DATABASE IF EXISTS db_materias_profesores;
    CREATE DATABASE db_materias_profesores CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci;
    USE db_materias_profesores;
