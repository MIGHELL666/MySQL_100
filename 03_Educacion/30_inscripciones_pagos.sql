DROP DATABASE IF EXISTS db_inscripciones_pagos;
    CREATE DATABASE db_inscripciones_pagos CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci;
    USE db_inscripciones_pagos;
