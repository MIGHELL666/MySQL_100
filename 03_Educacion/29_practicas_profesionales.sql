DROP DATABASE IF EXISTS db_practicas_profesionales;
    CREATE DATABASE db_practicas_profesionales CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci;
    USE db_practicas_profesionales;
