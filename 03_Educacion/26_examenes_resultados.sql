DROP DATABASE IF EXISTS db_examenes_resultados;
    CREATE DATABASE db_examenes_resultados CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci;
    USE db_examenes_resultados;
