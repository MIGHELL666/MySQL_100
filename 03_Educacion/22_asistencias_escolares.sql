DROP DATABASE IF EXISTS db_asistencias_escolares;
    CREATE DATABASE db_asistencias_escolares CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci;
    USE db_asistencias_escolares;
