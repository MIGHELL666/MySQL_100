DROP DATABASE IF EXISTS db_alumnos_calificaciones;
    CREATE DATABASE db_alumnos_calificaciones CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci;
    USE db_alumnos_calificaciones;
