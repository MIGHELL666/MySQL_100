DROP DATABASE IF EXISTS db_certificaciones_academicas;
    CREATE DATABASE db_certificaciones_academicas CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci;
    USE db_certificaciones_academicas;
