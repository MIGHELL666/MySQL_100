DROP DATABASE IF EXISTS db_contactos_personales;
    CREATE DATABASE db_contactos_personales CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci;
    USE db_contactos_personales;
