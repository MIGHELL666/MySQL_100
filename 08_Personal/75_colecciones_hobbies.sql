DROP DATABASE IF EXISTS db_colecciones_hobbies;
    CREATE DATABASE db_colecciones_hobbies CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci;
    USE db_colecciones_hobbies;
