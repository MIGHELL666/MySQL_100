DROP DATABASE IF EXISTS db_planificador_viajes;
    CREATE DATABASE db_planificador_viajes CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci;
    USE db_planificador_viajes;
