DROP DATABASE IF EXISTS db_plantas_cuidados;
    CREATE DATABASE db_plantas_cuidados CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci;
    USE db_plantas_cuidados;
