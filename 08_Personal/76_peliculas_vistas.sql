DROP DATABASE IF EXISTS db_peliculas_vistas;
    CREATE DATABASE db_peliculas_vistas CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci;
    USE db_peliculas_vistas;
