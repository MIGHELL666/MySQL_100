DROP DATABASE IF EXISTS db_hardware_dispositivos;
    CREATE DATABASE db_hardware_dispositivos CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci;
    USE db_hardware_dispositivos;
