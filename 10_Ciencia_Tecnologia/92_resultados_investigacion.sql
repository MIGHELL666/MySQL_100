DROP DATABASE IF EXISTS db_resultados_investigacion;
    CREATE DATABASE db_resultados_investigacion CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci;
    USE db_resultados_investigacion;
