DROP DATABASE IF EXISTS db_desarrollo_software;
    CREATE DATABASE db_desarrollo_software CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci;
    USE db_desarrollo_software;
