DROP DATABASE IF EXISTS db_astronomia_descubrimientos;
    CREATE DATABASE db_astronomia_descubrimientos CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci;
    USE db_astronomia_descubrimientos;
