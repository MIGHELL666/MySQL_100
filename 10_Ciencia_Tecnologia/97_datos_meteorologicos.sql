DROP DATABASE IF EXISTS db_datos_meteorologicos;
    CREATE DATABASE db_datos_meteorologicos CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci;
    USE db_datos_meteorologicos;
