DROP DATABASE IF EXISTS db_patentes_derechos;
    CREATE DATABASE db_patentes_derechos CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci;
    USE db_patentes_derechos;
