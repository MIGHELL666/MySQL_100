DROP DATABASE IF EXISTS db_pruebas_prototipos;
    CREATE DATABASE db_pruebas_prototipos CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci;
    USE db_pruebas_prototipos;
