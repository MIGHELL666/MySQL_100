DROP DATABASE IF EXISTS db_incidencias_bugs;
    CREATE DATABASE db_incidencias_bugs CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci;
    USE db_incidencias_bugs;
