DROP DATABASE IF EXISTS db_experimentos_cientificos;
    CREATE DATABASE db_experimentos_cientificos CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci;
    USE db_experimentos_cientificos;
