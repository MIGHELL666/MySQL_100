DROP DATABASE IF EXISTS db_inventario_tienda_ropa;
    CREATE DATABASE db_inventario_tienda_ropa CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci;
    USE db_inventario_tienda_ropa;
