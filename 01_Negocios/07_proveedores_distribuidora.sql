DROP DATABASE IF EXISTS db_proveedores_distribuidora;
    CREATE DATABASE db_proveedores_distribuidora CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci;
    USE db_proveedores_distribuidora;
