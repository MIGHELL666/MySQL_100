DROP DATABASE IF EXISTS db_pos_supermercado;
    CREATE DATABASE db_pos_supermercado CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci;
    USE db_pos_supermercado;
