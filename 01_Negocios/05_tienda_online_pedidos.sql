DROP DATABASE IF EXISTS db_tienda_online_pedidos;
    CREATE DATABASE db_tienda_online_pedidos CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci;
    USE db_tienda_online_pedidos;
