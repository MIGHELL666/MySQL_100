DROP DATABASE IF EXISTS db_stock_ferreteria;
    CREATE DATABASE db_stock_ferreteria CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci;
    USE db_stock_ferreteria;
