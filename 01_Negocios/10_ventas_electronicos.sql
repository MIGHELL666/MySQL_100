DROP DATABASE IF EXISTS db_ventas_electronicos;
    CREATE DATABASE db_ventas_electronicos CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci;
    USE db_ventas_electronicos;
