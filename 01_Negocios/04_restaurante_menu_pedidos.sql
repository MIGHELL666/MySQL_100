DROP DATABASE IF EXISTS db_restaurante_menu_pedidos;
    CREATE DATABASE db_restaurante_menu_pedidos CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci;
    USE db_restaurante_menu_pedidos;
