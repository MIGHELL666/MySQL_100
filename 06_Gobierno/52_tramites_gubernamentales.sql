DROP DATABASE IF EXISTS db_tramites_gubernamentales;
    CREATE DATABASE db_tramites_gubernamentales CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci;
    USE db_tramites_gubernamentales;
