DROP DATABASE IF EXISTS db_presupuestos_municipales;
    CREATE DATABASE db_presupuestos_municipales CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci;
    USE db_presupuestos_municipales;
