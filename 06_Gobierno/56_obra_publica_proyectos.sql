DROP DATABASE IF EXISTS db_obra_publica_proyectos;
    CREATE DATABASE db_obra_publica_proyectos CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci;
    USE db_obra_publica_proyectos;
