DROP DATABASE IF EXISTS db_ciudadanos_documentos;
    CREATE DATABASE db_ciudadanos_documentos CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci;
    USE db_ciudadanos_documentos;
