DROP DATABASE IF EXISTS db_ongs_voluntarios;
    CREATE DATABASE db_ongs_voluntarios CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci;
    USE db_ongs_voluntarios;
