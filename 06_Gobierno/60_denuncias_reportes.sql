DROP DATABASE IF EXISTS db_denuncias_reportes;
    CREATE DATABASE db_denuncias_reportes CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci;
    USE db_denuncias_reportes;
