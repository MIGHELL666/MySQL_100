DROP DATABASE IF EXISTS db_elecciones_votos;
    CREATE DATABASE db_elecciones_votos CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci;
    USE db_elecciones_votos;
