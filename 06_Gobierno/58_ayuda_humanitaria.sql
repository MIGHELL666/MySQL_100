DROP DATABASE IF EXISTS db_ayuda_humanitaria;
    CREATE DATABASE db_ayuda_humanitaria CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci;
    USE db_ayuda_humanitaria;
